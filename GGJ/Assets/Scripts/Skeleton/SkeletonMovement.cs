...
namespace Skeleton
{
    ...
    {
        [Header("Movement")] [SerializeField] float _turnTime;
        ...
        [Header("Gravity")] [SerializeField] LayerMask groundLayer;
        ...
        [Header("Stats")] public Vector3 CharVelocity;
        ...
        public void Move(Vector2 moveInput, Vector2 lookInput)
        {
            ...
            if (lookInput.magnitude > 0f && moveInput.magnitude > 0f)
            {
                ...
                float smoothedAngle = Mathf.SmoothDampAngle(transform.eulerAngles.y, targetAngle, ref _turnSpeed,
                    _turnTime * Time.timeScale);
        ...
        void Gravity()
        {
            ...
            {
                velocity += -Physics.gravity.magnitude * Time.deltaTime;
            }
